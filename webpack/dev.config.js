...
module.exports = {
	...
	entry: {
		'main': [
			...
			'bootstrap-sass!./src/view/theme/bootstrap.config.js',
			'font-awesome-webpack!./src/view/theme/font-awesome.config.js',
	...
	module: {
		loaders: [
			...
			{ test: /\.scss$/, loader: 'style!css?importLoaders=2&sourceMap!autoprefixer?browsers=last 2 version!scss?outputStyle=expanded&sourceMap' },
